...
class StoreResidentRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        |--------------------------------------------------------------------------
        |
        | Examples accepted before normalization:
        |
        | 0916 580 7893
        | 0916-580-7893
        | +63 916 580 7893
        ...
        if (is_string($contactNumber)) {
            ...
            */
            ...
            if (str_starts_with($contactNumber, '+63')) {
                ...
                $contactNumber =
                    '0' . substr($contactNumber, 3);

            } elseif (
                str_starts_with($contactNumber, '63')
                && strlen($contactNumber) === 12
            ) {

                $contactNumber =
                    '0' . substr($contactNumber, 2);
            }
    ...
    /**
     * Friendly field names used by Laravel
     * when generating validation messages.
     */
    ...
    /**
     * Convert empty optional text inputs
     * into null values.
     */
